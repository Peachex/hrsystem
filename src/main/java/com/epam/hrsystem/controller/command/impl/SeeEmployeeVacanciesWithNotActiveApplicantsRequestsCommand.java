...
/**
 * Action command shows employee's vacancies with not active applicants requests.
 *
 * @author Aleksey Klevitov
 */
public class SeeEmployeeVacanciesWithNotActiveApplicantsRequestsCommand implements ActionCommand {
    @Override
