...
/**
 * Action command shows deleted user reports.
 *
 * @author Aleksey Klevitov
 */
public class SeeDeletedReportsCommand implements ActionCommand {
    @Override
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        ...
        try {
            List<UserReport> reports = service.findDeletedUserReports();
            if (reports.size() > 0) {
