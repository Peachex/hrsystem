...
public class MailMessage {
    ...
    public static final String APPLICANT_PASSED_INTERVIEWS_MAIL_TEXT = "Hello! Congratulations, you have successfully passed all interviews." +
            " Our recruiter will contact you and tell about next steps."; //todo write mail text
    ...
    public static final String APPLICANT_FAILED_INTERVIEWS_MAIL_TEXT = "Hello! Sorry but you haven't successfully passed all interviews." +
            " It's okay because you got valuable experience that will help you in the future.";
    ...
    public static final String CREATION_USER_REPORT_RESPONSE_MAIL_TEXT = "Hello! The report you left has already been processed.\nResponse. ";
